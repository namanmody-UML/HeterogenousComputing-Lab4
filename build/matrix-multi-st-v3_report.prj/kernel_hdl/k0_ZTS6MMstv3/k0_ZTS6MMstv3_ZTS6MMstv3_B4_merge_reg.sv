...
// SystemVerilog created from k0_ZTS6MMstv3_ZTS6MMstv3_B4_merge_reg
...
module k0_ZTS6MMstv3_ZTS6MMstv3_B4_merge_reg (
    ...
    reg [31:0] ZTS6MMstv3_B4_merge_reg_data_reg_3_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_4_x_q;
    ...
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_9_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_10_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_11_x_q;
    reg [31:0] ZTS6MMstv3_B4_merge_reg_data_reg_12_x_q;
    ...
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_17_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_18_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_19_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_20_x_q;
    reg [31:0] ZTS6MMstv3_B4_merge_reg_data_reg_21_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_22_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_23_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_24_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_25_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_26_x_q;
    reg [0:0] ZTS6MMstv3_B4_merge_reg_data_reg_27_x_q;
    ...
    // ZTS6MMstv3_B4_merge_reg_data_reg_27_x(REG,36)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_27_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_27_x_q <= in_data_in_27_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_26_x(REG,35)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_26_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_26_x_q <= in_data_in_26_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_25_x(REG,34)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_25_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_25_x_q <= in_data_in_25_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_24_x(REG,33)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_24_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_24_x_q <= in_data_in_24_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_23_x(REG,32)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_23_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_23_x_q <= in_data_in_23_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_22_x(REG,31)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_22_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_22_x_q <= in_data_in_22_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_21_x(REG,30)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_21_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_21_x_q <= in_data_in_21_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_20_x(REG,29)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_20_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_20_x_q <= in_data_in_20_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_19_x(REG,28)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_19_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_19_x_q <= in_data_in_19_tpl;
        end
    end

    // ZTS6MMstv3_B4_merge_reg_data_reg_18_x(REG,27)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_18_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_18_x_q <= in_data_in_18_tpl;
        end
    end
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_17_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_12_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_9_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_4_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            ZTS6MMstv3_B4_merge_reg_data_reg_3_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_ZTS6MMstv3_B4_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    assign out_data_out_18_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_18_x_q;
    assign out_data_out_19_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_19_x_q;
    assign out_data_out_20_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_20_x_q;
    assign out_data_out_21_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_21_x_q;
    assign out_data_out_22_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_22_x_q;
    assign out_data_out_23_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_23_x_q;
    assign out_data_out_24_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_24_x_q;
    assign out_data_out_25_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_25_x_q;
    assign out_data_out_26_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_26_x_q;
    assign out_data_out_27_tpl = ZTS6MMstv3_B4_merge_reg_data_reg_27_x_q;
