...
// SystemVerilog created from k0_ZTS6MMstv3_ZTS6MMstv3_B16_merge
...
module k0_ZTS6MMstv3_ZTS6MMstv3_B16_merge (
    ...
    // out_c0_exe101855145(GPOUT,11)
    assign out_c0_exe101855145 = in_c0_exe101855145_0;

    // out_c0_exe111856148(GPOUT,12)
    assign out_c0_exe111856148 = in_c0_exe111856148_0;

    // out_c0_exe151860149(GPOUT,13)
    assign out_c0_exe151860149 = in_c0_exe151860149_0;

    // out_c0_exe41849135(GPOUT,14)
    assign out_c0_exe41849135 = in_c0_exe41849135_0;

    // out_c0_exe71852138(GPOUT,15)
    assign out_c0_exe71852138 = in_c0_exe71852138_0;

    // out_c0_exe81853141(GPOUT,16)
    assign out_c0_exe81853141 = in_c0_exe81853141_0;

    // out_c0_exe91854143(GPOUT,17)
    assign out_c0_exe91854143 = in_c0_exe91854143_0;
